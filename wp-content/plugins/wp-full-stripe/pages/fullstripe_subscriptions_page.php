						...
						<?php foreach ( $plans as $plan ): ?>
							...
							<tr>
								...
								<td class="column-amount_interval">
									<b><?php echo esc_html( sprintf( '%s%0.2f', MM_WPFS::get_currency_symbol_for( $plan->currency ), $plan->amount / 100.0 ) ); ?>
										/ <?php echo esc_html( $interval_label ); ?></b><br>
									<?php if ( $setup_fee > 0 ): ?>
										<?php echo esc_html( sprintf( '%s%0.2f', MM_WPFS::get_currency_symbol_for( $plan->currency ), $setup_fee / 100.0 ) ); ?>
									<?php else: ?>
