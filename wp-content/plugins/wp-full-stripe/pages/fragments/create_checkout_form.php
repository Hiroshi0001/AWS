...
<form class="form-horizontal wpfs-admin-form" action="" method="POST" id="create-checkout-form">
	...
	<div id="create-checkout-form-tab-payment" class="wpfs-tab-content">
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<input type="text" class="regular-text" name="form_name_ck" id="form_name_ck" maxlength="<?php echo $form_data::NAME_LENGTH; ?>">
			...
			<tr valign="top">
				...
				<td>
					<span id="alipay_usage_info_panel" style="display: none;">
	...
	<div id="create-checkout-form-tab-appearance" class="wpfs-tab-content">
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input type="text" class="regular-text" name="company_name_ck" id="company_name_ck" maxlength="<?php echo $form_data::COMPANY_NAME_LENGTH; ?>">
			...
			<tr valign="top">
				...
				<td>
					<input type="text" class="regular-text" name="prod_desc_ck" id="prod_desc_ck" maxlength="<?php echo $form_data::PRODUCT_DESCRIPTION_LENGTH; ?>">
			...
			<tr valign="top">
				...
				<td>
					<input type="text" class="regular-text" name="open_form_button_text_ck" id="open_form_button_text_ck" value="Pay With Card" maxlength="<?php echo $form_data::OPEN_BUTTON_TITLE_LENGTH; ?>">
			...
			<tr valign="top">
				...
				<td>
					<input type="text" class="regular-text" name="form_button_text_ck" id="form_button_text_ck" value="Pay {{amount}}" maxlength="<?php echo $form_data::BUTTON_TITLE_LENGTH; ?>">
	...
	<div id="create-checkout-form-tab-actions-after-payment" class="wpfs-tab-content">
		<table class="form-table">
			...
			<?php include( 'redirect_to_for_create_checkout.php' ); ?>
		</table>
	</div>
	<p class="submit">
