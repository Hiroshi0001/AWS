...
(function ($) {
    $(function () {
        ...
        function validCheckoutRedirect() {
            var validRedirect;
            if ($('#do_redirect_yes_ck').prop('checked')) {
                if ($('#form_redirect_to_page_or_post_ck').prop('checked')) {
                    validRedirect = validFieldWithMsg($('#form_redirect_page_or_post_id_ck'), 'Select page or post to redirect to');
                    $('.page_or_post-combobox-input').focus();
                } else if ($('#form_redirect_to_url_ck').prop('checked')) {
                    validRedirect = validFieldWithMsg($('#form_redirect_url_ck'), 'Enter an URL to redirect to');
                } else {
                    validRedirect = false;
                    showError('You must check at least one redirect type');
                    activateFieldTab($('#form_redirect_to_page_or_post_ck'));
                }
            } else {
                validRedirect = true;
            }
        ...
        function enable_combobox() {
            $('#create-payment-form .page_or_post-combobox-input').prop('disabled', false);
            $('#create-payment-form .page_or_post-combobox-toggle').button("option", "disabled", false);
        ...
        function enable_combobox_ck() {
            $('#create-checkout-form .page_or_post-combobox-input').prop('disabled', false);
            $('#create-checkout-form .page_or_post-combobox-toggle').button("option", "disabled", false);
        ...
        function disable_combobox() {
            $('#create-payment-form .page_or_post-combobox-input').prop('disabled', true);
            $('#create-payment-form .page_or_post-combobox-toggle').button("option", "disabled", true);
        ...
        function disable_combobox_ck() {
            $('#create-checkout-form .page_or_post-combobox-input').prop('disabled', true);
            $('#create-checkout-form .page_or_post-combobox-toggle').button("option", "disabled", true);
        ...
        $('#create-subscription-plan').submit(function (e) {
            ...
            if (valid) {
                var $form = $(this);
                do_ajax_post(admin_ajaxurl, $form, "Plan created.", true);
            }
        ...
        $('#create-checkout-form').submit(function (e) {
            ...
            var valid = validField($('#form_name_ck'), 'Name');
            ...
            valid = valid && validField($('#currency'), 'Currency', $('.currency-combobox-input'));
            valid = valid && validField($('#form_amount_ck'), 'Amount');
            valid = valid && validFieldByRegex($('#form_amount_ck'), regexPattern_NUMBER, 'Form Amount should only contain numbers.');
            valid = valid && validField($('#company_name_ck'), 'Form Title');
            valid = valid && validCheckoutRedirect();
