...
* NEW: You can set the payment currency per one-time payment form!
* NEW: You can set the payment currency and setup fee per subscription plan!
* NEW: We have split all payment forms into tabs, the plugin has become much easier to use.
* NEW: Added the %DATE% placeholder token to all plugin email notifications.
* Securely take payments from any page or post on your Wordpress website in over 100 currencies.
* Take payments in Bitcoin and with Alipay.
...
* Stripe Checkout style payment forms
