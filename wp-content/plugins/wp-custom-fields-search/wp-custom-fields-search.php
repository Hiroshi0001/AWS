 ...
 */
	...
	class DB_CustomSearch_Widget extends DB_Search_Widget {
		...
		function __construct($params=array()){
            ...
            add_filter('plugin_row_meta',array($this,'show_update_message'));
		}
		function init(){
        ...
        function show_update_message($meta){
            if(in_array("Version ".$this->currentVersion(),$meta)){
                $warning_img = plugins_url("css/warning.png",__FILE__);
                echo "<p><img src='$warning_img'/> The next version of this plugin will be a significant upgrade with much improved / updated functionality.  The <a href='http://www.webhammer.co.uk/wp-custom-fields-search-beta'>beta version is available here</a> it would be a great help if you could test it and let us know your findings.</p>

                        <p>The core plugin should be fully backward compatible.  However if you have customised the plugin or used the extension functionality the new plugin will likely be incompatible with your customisations, as such you may wish to switch to the legacy version of the plugin here to prevent wordpress from auto-updating.</p>";
            }
            return $meta;
        }
