    ...
    <form id="swpm-registration-form" name="swpm-registration-form" method="post" action="">
        ...
        <table>
            <tr class="swpm-registration-username-row">
                <td><label for="user_name"><?php echo SwpmUtils::_('Username') ?></label><p>※4文字以上<br>※半角英数字、半角記号のみ</p></td>
                <td><input type="text" id="user_name" class="validate[required,custom[SWPMUserName],minSize[4],ajax[ajaxUserCall]]" value="<?php echo esc_attr($user_name); ?>" size="50" name="user_name" /></td>
            </tr>
            ...
            <tr class="swpm-registration-email-retype-row">
                <td><label for="email_re"><?php echo SwpmUtils::_('メールアドレス(確認)') ?></label></td>
                <td><input type="text" id="email_re" class="validate[required,equals[email]" value="<?php echo esc_attr($email_re); ?>" size="50" name="email_re" /></td>
            </tr>
            <tr class="swpm-registration-password-row">
                <td><label for="password"><?php echo SwpmUtils::_('Password') ?></label></td>
                <td><input type="password" autocomplete="off" id="password" value="" size="50" class="validate[required] text-input" name="password" /></td>
            </tr>
            <tr class="swpm-registration-password-retype-row">
                <td><label for="password_re"><?php echo SwpmUtils::_('パスワード(確認)') ?></label></td>
                <td><input type="password" autocomplete="off" id="password_re" value="" size="50" class="validate[required,equals[password]] text-input" name="password_re" /></td>
            </tr>
            ...
            <tr class="swpm-registration-course-row">
                <td><label for="membership_level"><?php echo SwpmUtils::_('コース') ?></label></td>
                <td><?php echo $membership_level_alias;
...
?></td>
            ...
            <tr class="swpm-registration-company-name-row">
                <td><b><?php echo SwpmUtils::_('メール送信の可否'); ?></b></td>
                <td><label style="font-weight:normal" for="company_name"><input type="checkbox" id="company_name" <?php echo $company_name ? "checked":""; ?> size="50" name="company_name" />イベント通知メールを受け取る（重要なメールは常に送信されます）</label></td>
            </tr>
            <tr><td colspan=2">※<a href="/admission" target="_blank">規約</a>に同意の上、下記の新規登録ボタンを押してください。</td>
        </table>        
        ...
        <div class="swpm-registration-submit-section" align="center">
            <input type="submit" value="<?php echo SwpmUtils::_('新規登録') ?>" class="swpm-registration-submit" name="swpm_registration_submit" />
        </div>
