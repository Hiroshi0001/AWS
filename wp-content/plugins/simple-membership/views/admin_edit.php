<div class="wrap" id="swpm-profile-page" type="edit">
    ...
    <?php include('admin_member_form_common_part.php');?>
        ...
        <tr>
		<th scope="row"><label for="extra_info"><?php echo  SwpmUtils::_('メール送信の可否') ?> </label></th>
		<td><input class="regular-text" name="extra_info" type="text" id="extra_info" value="<?php echo esc_attr($extra_info); ?>" /></td>
	</tr>
        <tr>
